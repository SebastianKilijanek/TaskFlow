...
public record AddCommentCommand(Guid UserId, Guid TaskItemId, string Content)
    : IRequest<Guid>, IUserExistenceRequest, IEntityExistenceRequest<TaskItem>, IBoardAuthorizableRequest
{
